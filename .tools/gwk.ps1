...
.DESCRIPTION
	Lists and manages Git worktrees from a terminal UI.
	...
	Needs an interactive console terminal; PowerShell ISE is not supported.

.PARAMETER Setup
	Install mode: copies the script to ~/Scripts, updates PATH, installs launchers/alias. Alias: -s.

.PARAMETER Help
	Show help. Alias: -h.

.PARAMETER Version
	Show version. Alias: -v.

.PARAMETER Doctor
	Run diagnostics instead of the TUI.

.PARAMETER ConfigPath
	Custom config file path (default: $env:GWK_CONFIG or ~/.gwk.json).
